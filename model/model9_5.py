...
class base(nn.Module):
    def __init__(self,nfeats=64,dwconv=common.DepthWiseConv,conv=default_conv):
        ...
        self.base3 = base_block1()

        self.attn0 = esa.ESA(nfeats)
        self.attn1 = common.ChannelAttention(in_planes=64)
...
class NET(nn.Module):
    def __init__(self, scale=2,nfeats=64, conv=common.default_conv):
        ...
        self.block0 = base(nfeats=64)
        self.block1 = base(nfeats=64)
        self.block2 = base(nfeats=64)
        self.block3 = base(nfeats=64)
