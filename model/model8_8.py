...
class Myattn(nn.Module):
    def __init__(self,n_feats,conv=default_conv,dwconv=common.DepthWiseConv):
        ...
        self.conv0 = dwconv(n_feats, n_feats)
        self.conv1 = base_block0(n_feats, n_feats)
        self.conv2 = base_block0(n_feats, n_feats)
...
class base_block0(nn.Module):
    ...
    def forward(self,x):
        ...
        return x1
class base_block2(nn.Module):
    def __init__(self,dim=64):
        super(base_block2, self).__init__()
        self.norm0 = LayerNorm(dim)
        self.norm1 = LayerNorm(dim)
        self.block0 = Myattn(n_feats=dim)
        self.block1 = basic_block(dim)
    def forward(self,x):
...
class base_block1(nn.Module):
    def __init__(self,nfeats=64,dwconv=common.DepthWiseConv,conv=default_conv):
        ...
        #
        # )
        self.base_block0 = base_block2(nfeats)
        self.base_block1 = base_block2(nfeats)
        self.base_block2 = base_block2(nfeats)
